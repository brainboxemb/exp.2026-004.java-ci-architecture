...
This proves fresh-runner/cross-job reuse, not yet retention across separate workflow runs. Repeated performance measurements, cross-workflow retention if needed, and release/canonical-artifact policy remain before any production rollout decision.
